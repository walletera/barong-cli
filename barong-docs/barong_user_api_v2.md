...
### /api/v1/auth/identity/users/password/confirm_code
...
### /api/v1/auth/identity/users/password/generate_code
...
### /api/v1/auth/identity/users/email/confirm_code
...
### /api/v1/auth/identity/users/email/generate_code
...
### /api/v1/auth/identity/users/register_geetest
...
### /api/v1/auth/identity/users/access
...
### /api/v1/auth/identity/password/validate
...
### /api/v1/auth/resource/swagger_doc/{name}
...
### /api/v1/auth/resource/swagger_doc
...
### /api/v1/auth/resource/service_accounts/api_keys/{kid}
...
### /api/v1/auth/resource/service_accounts/api_keys
...
### /api/v1/auth/resource/service_accounts
...
### /api/v1/auth/resource/data_storage
...
### /api/v1/auth/resource/api_keys/{kid}
...
### /api/v1/auth/resource/otp/verify
...
### /api/v1/auth/resource/otp/disable
...
### /api/v1/auth/resource/otp/enable
...
### /api/v1/auth/resource/otp/generate_qrcode
...
### /api/v1/auth/resource/phones/verify
...
### /api/v1/auth/resource/phones/send_code
...
### /api/v1/auth/resource/documents
...
### /api/v1/auth/resource/profiles/me
...
### /api/v1/auth/resource/labels/{key}
...
### /api/v1/auth/resource/users/password
...
### /api/v1/auth/resource/users/activity/{topic}
...
### /api/v1/auth/resource/addresses
...
### /api/v1/auth/public/password/validate
